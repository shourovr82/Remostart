    ...
    const compo = (
        <div className="mt-4 bg-white leading-relaxed mb-8 border md:flex justify-around items-center border-[#FF9900] rounded-md p-2">
            ...
            <div className="flex-1">
                ...
                <p className="text-xs">
                    Hey there new user! We just wanted to inform you that we use cookies to ensure
                    you have the best browsing experience on our website. Please read our terms and
                    conditions.
                </p>
            </div>
        </div>
