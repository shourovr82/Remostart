                ...
                <div className="col-span-5 pr-0 lg:pr-2">
                    <div className="rounded-lg bg-[#F0F9FFBF] p-2">
                        ...
                        <p className="text-sm font-semibold mt-2">
                            {remoProfile?.personalDetails?.aboutMe}
                        </p>
                    </div>
                            ...
                            <div className="space-y-4">
                                {remoProfile?.socialLinks?.Github && (
                                    ...
                                    >
                                        ...
                                        <span className="text-sm font-semibold">
                                            {`@${remoProfile?.socialLinks?.Github.split(
                                                '/'
                                            ).pop()}`}
                                        </span>
                                    </a>
                                ...
                                {remoProfile?.socialLinks?.Instagram && (
                                    ...
                                    >
                                        ...
                                        <span className="text-sm font-semibold">
                                            {`#${remoProfile?.socialLinks?.Instagram.split(
                                                '.com/'
                                            ).pop()}`}
                                        </span>
                                    </a>
                                ...
                                {remoProfile?.socialLinks?.Linkedin && (
                                    ...
                                    >
                                        ...
                                        <span className="text-sm font-semibold">
                                            {`${remoProfile?.socialLinks?.Linkedin.split(
                                                'www.'
                                            ).pop()}`}
                                        </span>
                                    </a>
                                ...
                                {remoProfile?.socialLinks?.Twitter && (
                                    ...
                                    >
                                        ...
                                        <span className="text-sm font-semibold">
                                            {`@${remoProfile?.socialLinks?.Twitter.split(
                                                '/'
                                            ).pop()}`}
                                            {}
                                        </span>
