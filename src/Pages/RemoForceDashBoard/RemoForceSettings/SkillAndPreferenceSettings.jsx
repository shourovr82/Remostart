...
function SkillAndPreferenceSettings() {
    ...
    const Submit = async (data) => {
        ...
        await axios
            .put(
                `${process.env.REACT_APP_URL_STARTUP}/api/remoforce/remoforce-settings-skills`,
                bodyData
            )
            .then((res) => {
                ...
                >
                    ...
                    <div className=" w-full flex bg-[#F0F9FFBF]  rounded-lg flex-col p-2 lg:p-5">
                        ...
                        <div className="flex flex-nowrap justify-between items-center border-b border-b-[#19a5ff] lg:w-[14rem]  mb-5 ">
                            ...
                            <h1 className="text-[#19a5ff]  font-sans font-semibold text-xl w-[89%]">
                                Languages
                            </h1>
                        </div>
                        {/* Skill body */}
                                ...
                                <div className="flex flex-wrap gap-2 xl:gap-0">
                                    {buttons.map((item) => (
                                        ...
                                        >
                                            <span
                                                className={`mr-1  ${
                                                    preferredJobType === item.name && ' text-white '
                                                }`}
                                            >
                                                {item.icon}
                                            </span>
