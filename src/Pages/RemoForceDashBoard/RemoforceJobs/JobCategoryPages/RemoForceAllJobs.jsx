    ...
    <RemoForceDashBoardItems>
      <section>
        ...
        {allJobs.length ? (
          ...
          //                 <p className="text-xs px-[5px] py-[5px] bg-green-100 rounded-md ">
          //                   {skill}
          //                 </p>
          //               </div>
          //             ))}
          ...
          //           <h4 className="text-start text-green-900 font-bold">
          //             Salary : {item?.salary} ₳{' '}
          //           </h4>
          //         </div>
          ...
          //   ))}
          // </section>
          <JobCard allJobsInfo={allJobs} applyNowBtn={handleApplyNow} />
        ) : (
          <NoJob />
        )}
      </section>
