        ...
        >
          <div className="flex justify-between  items-center">
            <div className="flex items-center gap-5">
              {item?.startupsProfilePhoto ? (
                <img className="w-8 h-8 rounded-full" src={item.startupsProfilePhoto} alt="" />
              ) : (
          ...
          <div className="mt-1">
            ...
            <div className="mt-3 border-b pb-2">
              <h4 className="text-start text-green-900 font-bold">Salary : {item?.salary} ₳ </h4>
            </div>
