...
const PostJobShowinJobReview = () => {
  return (
    <div >
      ...
      <button type='button'  className='px-[46px] py-[21px] bg-[#0B132A] rounded-md text-white'>Post Public Job</button>
      <button type='button'  className='px-[46px] py-[21px] border-2 border-[#0B132A]  rounded-md text-black'>Edit</button>
      </div>
    </div>
  )
}
