    ...
    return (
        <div>
            ...
            <p className="text-gray-400 mt-6 lg:mt-1">
                The flexible and permissionsless job platform. Its job with social good. Pay talents
                while ADA they are learning on the job, while we do the certification.
            </p>
