    ...
    return (
        <section className="flex flex-col w-full">
            ...
            <p className=" font-semibold text-[#999999] mt-4">
                We have diffferent kind of jobs that you may want to post, this is where you get the
                jobs posted and it will automatically be sent to the matching talents, dont forget
                to put the qualifieers so only the right talent will apply.
            </p>
                    ...
                    >
                        ...
                        <div className="flex flex-col items-center text-center space-y-5 px-4">
                            ...
                            {item.comingSoon === 'false' && (
                                <Link
                                    className="border-2 py-1 text-sm font-bold px-6 rounded-3xl hover:bg"
                                    to={`/dashboard/post-job/${item.categoryName
                                        .replace(/ /g, '-')
                                        .toLowerCase()}`}
                                >
                                    Create
                            ...
                            {item.comingSoon === 'true' && (
                                ...
                                >
                                    <button
                                        disabled
                                        type="button"
                                        className="border-2 py-1 text-sm font-bold px-6 rounded-3xl disabled:text-gray-400 hover:bg"
                                    >
                                        Coming Soon
                                    </button>
                                </Link>
