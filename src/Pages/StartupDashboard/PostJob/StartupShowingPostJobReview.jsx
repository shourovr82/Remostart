...
const StartupShowingPostJobReview = () => {
    return (
        <div >
      {/* Banar Section start */}
      <div className="bg-gradient-to-r border border-[#FEE719] absolute from-[#FEE719]  to-[#fee71926] w-[1160px] h-[160px] rounded-2xl ">
        ...
        <div className="flex justify-end mt-[34px] gap-[10px] ">
          <a href="share">
            {' '}
            <BiBookmarks className="text-[#19A5FF] text-2xl text-right"></BiBookmarks>
          </a>
          <a href="/">
            {' '}
            <RiShareForwardLine className="text-[#19A5FF] text-2xl text-right mr-[30px]"></RiShareForwardLine>
          </a>
        </div>
      </div>
      {/* Banner End  */}
      ...
      <div className="mt-[121px] lg:flex ">
        <div className="lg:w-[850px] lg:px-[66px]">
          ...
          <div className='w-[330px] bg-blue-400' style={{ border: '2px solid rgba(25, 165, 255, 1)'}}> </div>
        ...
        <div className="flex justify-end p-[4px] ">
          <a href="linkdin">
            <GrLinkedin className="text-[#19A5FF] text-2xl rounded-full text-right"></GrLinkedin>
          </a>
        ...
        <div className="w-[330px] lg:border-l-2 pl-4  border-t-2  lg:border-t-0">
          <div>
            ...
            <div className="flex gap-3 mt-3">
              <div className="bg-[#F0F9FF] text-center rounded-md ">
                <p className="text-sm py-[8px] px-[22px]">
                  lorem manoig ipsone
                </p>
              </div>
              <div className="bg-[#F0F9FF]  rounded-md ">
            ...
            <div className="bg-[#F0F9FF] mt-3 w-[300px] rounded-md ">
              <p className="text-sm px-[25px] py-[8px] ">
                Basic Java Knowledge (JDK 14.2 Above)
              </p>
            </div>
          ...
          <div>
            ...
            <div className="">
              <div className="bg-[#F0F9FF] mt-3 w-[170px] flex items-center gap-3 rounded-md ">
                <p className="text-sm pl-[15px] py-[8px] ">
                  <GiSandsOfTime className="text-red-500"></GiSandsOfTime>
                </p>
            ...
            <tbody>
              <tr className="bg-gray-100 text-center border-b text-sm text-gray-600">
                ...
                <td className="flex gap-5 justify-center">
                  <button type='button'  className="bg-blue-500  p-2 text-white hover:shadow-lg text-xs font-semibold">
                    <TiTick></TiTick>
                  </button>
                  <button type='button'  className="bg-red-500 p-2 rounded-md text-white hover:shadow-lg text-xs font-semibold">
                    <RxCross2></RxCross2>
                  </button>
                </td>
              </tr>
...
export default StartupShowingPostJobReview;