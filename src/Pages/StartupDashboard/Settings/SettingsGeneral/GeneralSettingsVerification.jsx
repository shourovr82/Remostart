        ...
        <div>
                ...
                startupData.registered ? (
                    <div className="lg:space-y-5 space-y-3 mt-7">
                        <h2 className=" lg:text-2xl text-lg font-semibold">
                            Startup Name :
                            <span className="font-normal">{startupData.startupName}</span>
                        </h2>
                        <h2 className=" lg:text-2xl text-lg font-semibold">
                            Registered Name :{' '}
                            <span className="font-normal">{startupData.registeredName}</span>
                        </h2>
                        <h2 className=" lg:text-2xl text-lg font-semibold">
                            Company CIN Number :{' '}
                            <span className="font-normal">{startupData.startupCIN}</span>
                        </h2>
                    ...
                    <div className="space-y-5 mt-7">
                        ...
                        <div className="flex space-x-8">
                            ...
                            <h2 className="text-2xl font-semibold">
                                Incubated at :{' '}
                                <span className="font-normal">
                                    {startupData?.companyAddress?.incubatedAt}
                                </span>
                            </h2>
                        </div>
                        <h2 className="text-2xl font-semibold">
            ...
            <div className="mt-8">
                <div className="lg:w-[773px] ">
                    {/* section title */}
                    <h1 className="text-[#475569] font-medium text-[15px]">
