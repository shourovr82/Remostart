                        ...
                        <div className="grid grid-cols-6 mt-6 gap-4 col-span-full lg:col-span-3">
                            <div className="col-span-full sm:col-span-5 space-y-1">
                                ...
                                <p className="pt-1">
                                    <span className="text-red-400 ">
                                        {errors.startupName && (
                                            <span>Invalid your email address</span>
                                        )}
                                    </span>
                                </p>
                            </div>
                                ...
                                <p className="pt-1">
                                    <span className="text-red-400 ">
                                        {errors.startupSlogan && (
                                            <span>Your Slogan is not Valid</span>
                                        )}
                                    </span>
                                </p>
                            </div>
                                ...
                                <p className="pt-1">
                                    <span className="text-red-400 ">
                                        {errors.startupDescription && (
                                            <span>Please Input Description</span>
                                        )}
                                    </span>
                                </p>
                            </div>
                            <div className="col-span-full mt-12 space-y-1">
                                ...
                                <p className="pt-1">
                                    <span className="text-red-400 ">
                                        {errors.worksIn && (
                                            <span>Please Input Industries work in details</span>
                                        )}
                                    </span>
                                </p>
                            </div>
