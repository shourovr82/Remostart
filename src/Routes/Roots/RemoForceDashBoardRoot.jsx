...
import { AiOutlineLogout, AiOutlineProfile, AiOutlineSetting } from 'react-icons/ai';
        ...
        <section className="flex">
            <div className="hidden w-[160px]  text-center space-y-4 h-full flex-col lg:flex items-center rounded-md py-10 cardShadow">
                ...
                >
                    ...
                    <span className="font-normal text-sm leading-4">Get Verified</span>
                </NavLink>
                <NavLink
                ...
                >
                    ...
                    <span className="font-normal text-sm leading-4">Shadowing</span>
                </NavLink>
                <NavLink
