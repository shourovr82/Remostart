...
const DashBoardItems = ({ children }) => {
    ...
    return (
            ...
            <div className="flex justify-start items-start lg:justify-between lg:items-center flex-col-reverse lg:flex-row">
                <nav className="flex list-none mt-5 items-start  space-y-2   mb-6 w-[fit-content] flex-wrap">
                    <li className="space-x-1 mt-2 font-semibold text-xs sm:text-sm">
                        ...
                        >
                            <AiOutlineMenu className="xs:hidden inline-block text-xs md:text-xl mb-px " />{' '}
                            All jobs
                        </NavLink>
                    </li>
                    <li className="space-x-1 font-semibold text-xs sm:text-sm">
                        ...
                        >
                            <VscLayersActive className="xs:hidden inline-block text-xs md:text-xl mb-px" />{' '}
                            Active jobs
                        </NavLink>
                    </li>
                    <li className="space-x-1 font-semibold text-xs sm:text-sm">
        ...
        //     <div className="h-[2px] w-full bg-slate-500 mt-4" />
        //     <div className="flex justify-start items-start lg:justify-between lg:items-center flex-col-reverse lg:flex-row">
        //         <nav className="flex list-none mt-5 items-start border-b-2 space-y-2 space-x-3 pb-2 mb-6 w-[fit-content] flex-wrap">
        //             <li className="space-x-1 mt-2 font-semibold text-xs sm:text-sm">
        //                 <NavLink
        //                     to="/dashboard/all_jobs"
        //                     className={({ isActive }) => isActive && categoryActive}
        //                 >
        //                     <FcMenu className=" xs:hidden inline-block text-xs md:text-xl mb-px" />{' '}
        //                     All jobs
        //                 </NavLink>
        //             </li>
        //             <li className="space-x-1 font-semibold text-xs sm:text-sm">
...
//     <div className="h-[2px] w-full bg-slate-500 mt-4" />
//     <div>
//         <nav className="flex space-x-8 list-none font-semibold text-sm mt-5 items-center border-b-2 w-5/12">
//             <li className="py-2 space-x-1">
//                 <Link to="/dashboard/all_jobs">
//                     <FcMenu className="inline-block text-xl mb-px" /> All jobs
//                 </Link>
//             </li>
//             <li className="py-2 space-x-1">
//                 <Link to="/dashboard/active_jobs">
//                     <VscLayersActive className="inline-block text-xl mb-px" /> Active jobs
//                 </Link>
//             </li>
//             <li className="py-2 space-x-1">
//                 <Link to="#">
//                     <AiOutlineCloseSquare className="inline-block text-xl mb-px" /> Close jobs
//                 </Link>
//             </li>
//             <li className="py-2 space-x-1">
//                 <Link to="#">
//                     <RxShadow className="inline-block text-xl mb-px" /> Shaddowing
//                 </Link>
//             </li>
//         </nav>
//     </div>
